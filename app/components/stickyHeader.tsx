...
export function StickyHeader() {
  return (
    <div className="flex sticky top-0 bg-stone-950/75 border-b-[1px] border-stone-300 border-dotted backdrop-blur-lg text-white py-[5px] z-50 shadow-lg items-center">
      <Button
        asChild
